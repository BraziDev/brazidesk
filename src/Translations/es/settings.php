...
ENDHTML
    ...
    , 'include_font_awesome' => <<<'ENDHTML'
			<p>Si Font-awesome css se incluyo fuera de brazidesk, deberías configurar esto como <code>0</code></p>
