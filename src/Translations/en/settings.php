...
ENDHTML
    ...
    , 'include_font_awesome' => <<<'ENDHTML'
			<p>If Font-awesome css is included outside brazidesk, this should be set to <code>0</code></p>
